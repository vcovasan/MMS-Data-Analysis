function [V] = shockVelocity3(i1,i2,i4, N)
...
%rxyz(i1,:)
r1x=r1x(1:min([length(r1x), length(r2x), length(r4x)]));
r2x=r2x(1:min([length(r1x), length(r2x), length(r4x)]));
r4x=r4x(1:min([length(r1x), length(r2x), length(r4x)]));

r1y=r1y(1:min([length(r1y), length(r2y), length(r4y)]));
r2y=r2y(1:min([length(r1y), length(r2y), length(r4y)]));
r4y=r4y(1:min([length(r1y), length(r2y), length(r4y)]));


r1z=r1z(1:min([length(r1z), length(r2z), length(r4z)]));
r2z=r2z(1:min([length(r1z), length(r2z), length(r4z)]));
r4z=r4z(1:min([length(r1z), length(r2z), length(r4z)]));
...
vx=mean([vx24 vx12 vx14]);% see the shape of the tetrahedron to check
vy=mean([vy12 vy14 vy24]);%  which pairs are reliable and which not
vz=mean([vz24 vz12 vz14]);% if too close, discard 
...
minLength=min([length(r1),length(r2),length(r4)]);% normalise wrt the shortest dataset 
r1=r1(1:minLength);
r2=r2(1:minLength);
%r3=r3(1:minLength);
r4=r4(1:minLength);
