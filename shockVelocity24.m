...
function [V] = shockVelocity24(i1,i3, N)
...
minLengthrx=min([length(r1x) length(r3x)]);
minLengthry=min([length(r1y) length(r3y)]);
minLengthrz=min([length(r1z) length(r3z)]);

r1x=r1x(1:minLengthrx);
r3x=r1x(1:minLengthrx);

r1y=r1y(1:minLengthry);
r3y=r1y(1:minLengthry);

r1z=r1z(1:minLengthrz);
r3z=r1z(1:minLengthrz);
...
minLength=min([length(r1),length(r3)]);% normalise wrt the shortest dataset
r1=r1(1:minLength);
%r2=r2(1:minLength);
r3=r3(1:minLength);
%r4=r4(1:minLength);
