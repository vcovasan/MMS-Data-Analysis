...
%k_min=find(l==min(l));
N = [-0.8597    0.2574   -0.4412]'; % the eigenvector defining the normal boundary direction; N from LMN found
...
plot([i1:i2],Bn)
xlabel('Index');
ylabel('B_{N}'); % the magnetic jump in this one should be less than 10% of the jump in the total B 
...
%irf_minvar_gui([interval' bx by bz]);
